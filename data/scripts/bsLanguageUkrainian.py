...
values = {
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeInstructionsText':('Для активації в ${APP_NAME} зайдіть в "Налаштування->Додатково->Ввести промо-код".\n'
        ...
        'friendPromoCodeWhereToEnterText':'(В "Налаштування->Додатково->Ввести промо-код")',
    ...
    'settingsWindowAdvanced':{
        ...
        'benchmarksText':'Тест продуктивності і тест-навантаження',
        ...
        'translationInformMe':'Повідомила нам, якщо ваша мова потребує оновлення',
