...
values = {
    ...
    'achievements':{
        ...
        'Boxer':{
            ...
            'descriptionFullComplete':'قد اكملت المستوى ${LEVEL} دون ان تستخدم اي من القنابل',
            'name':'ملاكم'
        },
        'Dual Wielding':{
        ...
        'Free Loader':{
            ...
            'descriptionFullComplete':'بدا العب الحر ل اكثر من لاعبين',
            'name':'المستغل'
        },
        'Gold Miner':{
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeInstructionsText':('لاستخدامه، افتح ${APP_NAME} وانتقل إلى "إعدادات-> متقدمة-> أدخل الرمز الترويجي".\n'
                                           'انظر bombsquadgame.com للحصول على وصلات التحميل لجميع المنصات المعتمدة.'),
        ...
        'friendPromoCodeWhereToEnterText':'(في "إعدادات-> متقدمة-> أدخل الرمز الترويجي")',
    ...
    'settingsWindowAdvanced':{
        ...
        'enterPromoCodeText':'إدخال الرمز الترويجي',
