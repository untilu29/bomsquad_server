...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsInstructionsNewText':('Чтобы связать две учетные записи, сгенерируйте код на первом\n'
                                           ...
                                           '\n'
                                           'Вы можете связать аккаунты ${COUNT}.\n'
                                           '\n'
                                           'ВАЖНО: только собственные учетные записи;\n'
                                           'Если вы связываетесь с аккаунтами друзей, вы не сможете\n'
                                           'одновременно играть в онлайн.'),
        ...
        'nameChangeConfirm':'Вы уверенным что хотите сменить имя на ${NAME}?',
        ...
        'setAccountName':'Задайте имя учетной записи',
        ...
        'unlinkAccountsText':'Отвязанные аккаунты',
    ...
    'alreadySignedInText':('На вашем аккаунте играют на другом устройстве;\n'
                           'пожалуйста зайдите с другого аккаунта или закройте игру на\n'
                           'другом устройстве и перезайдите в игру.'),
    ...
    'configGamepadWindow':{
        ...
        'uiOnlyDescriptionText':'(Отключить этот контроллер присоединяясь к игре)',
    ...
    'coopSelectWindow':{
        ...
        'skipWaitText':'Ускорить ожидание',
