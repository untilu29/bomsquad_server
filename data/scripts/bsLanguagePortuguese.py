...
values = {
    ...
    'settingsWindowAdvanced':{
        ...
        'enterPromoCodeText':'Inserir código promocional',
    ...
    'translations':{
        ...
        'coopLevelNames':{
            '${GAME} Training':'Treinamento ${GAME}',
        ...
        'serverResponses':{
            ...
            ('Server functionality is no longer supported in this version of the game;\n'
             'Please update to a newer version.'):('Funcionalidade do servidor não é suportada por essa versão do jogo;\n'
                                                   'Por favor atualize para a nova versão.'),
